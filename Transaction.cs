...
namespace Supportbank
{
    ...
    {
        //properties 
        public string TransactionDates { get; }
        ...
        public Transaction(string transactionDates, string fromUser, string toUser, string transactionDescription, double transactionAmount)
        {
